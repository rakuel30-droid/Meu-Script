-- ============================================
-- AETHER MOBILE v2.0 - DELTA EXECUTOR
    ...
    for _, btnInfo in ipairs(botoes) do
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            elseif btnInfo.texto == "📊 STATUS" then
                ...
                print("  - Nível:", player:FindFirstChild("Data") and player.Data.Level.Value or 0)
                print("  - Fruta:", player:FindFirstChild("Data") and player.Data.Fruit.Value or "Nenhuma")
...
pcall(function()
    game:GetService("ReplicatedStorage"):WaitForChild("DefaultChatSystemChatEvents")
        :WaitForChild("OnMessageDoneFiltering").OnClientEvent:Connect(function(msg)
            if msg.FromSpeaker == player.Name then
                if msg.Message == "!farm" then
                    Aether.Config.AutoFarm = not Aether.Config.AutoFarm
                    print("[Aether] Auto Farm:", Aether.Config.AutoFarm and "ATIVADO ✅" or "DESATIVADO ❌")
                    
                elseif msg.Message == "!coletar" then
                    Aether:ColetarTodosItensMapa()
                    
                elseif msg.Message == "!tp vulcanica" then
                    Aether:TeleportarIlhaVulcanica()
                    
                elseif msg.Message == "!tp miragem" then
                    Aether:TeleportarIlhaMiragem()
                    
                elseif msg.Message == "!buscar" then
                    Aether:BuscarIlhasNoMar()
                    
                elseif msg.Message == "!status" then
                    print("[Aether] Status:")
                    print("  - Auto Farm:", Aether.Config.AutoFarm)
                    print("  - Nível:", player:FindFirstChild("Data") and player.Data.Level.Value or 0)
                    print("  - Fruta:", player:FindFirstChild("Data") and player.Data.Fruit.Value or "Nenhuma")
